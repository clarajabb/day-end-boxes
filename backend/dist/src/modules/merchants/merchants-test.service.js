...
exports.MerchantsTestService = void 0;
const common_1 = require("@nestjs/common");
let MerchantsTestService = class MerchantsTestService {
    constructor() {
        this.merchantStore = new Map();
    ...
    async getMostSustainable(limit = 5) {
        return Array.from(this.merchantStore.values())
            .filter(merchant => merchant.status === 'APPROVED')
    ...
    async createTestMerchant(merchantData) {
        const newMerchant = {
...
exports.MerchantsTestService = MerchantsTestService;
exports.MerchantsTestService = MerchantsTestService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [])
], MerchantsTestService);
//# sourceMappingURL=merchants-test.service.js.map